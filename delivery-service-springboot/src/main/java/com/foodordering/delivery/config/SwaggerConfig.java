...
public class SwaggerConfig {
    ...
    @Value("${app.openapi.dev-url:http://localhost:8085}")
    ...
    public OpenAPI deliveryServiceOpenAPI() {
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .contact(contact)
                .description("This API manages food delivery operations and tracking. " +
                        "It handles delivery assignment, real-time tracking, delivery status updates, " +
                        "and provides comprehensive delivery management functionality.")
