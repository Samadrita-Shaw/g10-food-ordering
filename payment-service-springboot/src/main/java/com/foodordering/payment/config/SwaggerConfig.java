...
public class SwaggerConfig {
    ...
    @Value("${app.openapi.dev-url:http://localhost:8084}")
    ...
    public OpenAPI paymentServiceOpenAPI() {
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .contact(contact)
                .description("This API handles payment processing for food orders. " +
                        "It manages payment methods, processes transactions, handles refunds, " +
                        "and provides comprehensive payment tracking and security features.")
