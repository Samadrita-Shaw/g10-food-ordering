...
public class SwaggerConfig {
    ...
    public OpenAPI userServiceOpenAPI() {
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .contact(contact)
                .description("This API provides comprehensive user management functionality for the Food Ordering System. " +
                        "It handles user registration, authentication, profile management, and user-related operations.")
